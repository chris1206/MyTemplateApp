 ...
 * @date 2016-01-27
 *
 * modify by chris 18-01-26
 * add custom modify incator color
 */
...
//    private AdapterChangeListener mAdapterChangeListener;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDefaultIndicatorColor = QMUIResHelper.getAttrColor(context, com.qmuiteam.qmui.R.attr.qmui_config_color_blue);
    ...
    private void createIndicatorView() {
        if (mIndicatorView == null) {
            ...
            if (mIndicatorDrawable != null) {
                ...
                //chris add
//                setIndicatorColor(mDefaultSelectedColor);
//                mIndicatorView.setBackgroundColor(mDefaultSelectedColor);
                mIndicatorView.setBackgroundColor(mDefaultIndicatorColor);
            }
...
//            viewPager.addOnAdapterChangeListener(mAdapterChangeListener);
    ...
    public void setDefaultIndicatorColor(@ColorInt int defaultIndicatorColor) {
        mDefaultIndicatorColor = defaultIndicatorColor;
    }
...
//                mIndicatorView.setBackgroundColor(indicatorColor);
    ...
    /**
     * Chris add 增加自定义indicator颜色
     */
//    public void setIndicatorColor(int color) {
//        mIndicatorView.setBackgroundColor(color);
//        mDefaultIndicatorColor = color;
//    }
...
//                        mIndicatorView.setBackgroundColor(getTabSelectedColor(item));
    ...
    public class InnerTextView extends android.support.v7.widget.AppCompatTextView {
