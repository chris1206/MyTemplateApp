package com.yto.template.okhttpdownload;

import com.yto.template.App;
import com.yto.template.utils.CloseUtils;
...
public class DownloadManager {
    ...
    private static File mFile =  App.getAppContext().getFilesDir();
    //获得一个单例类
    ...
    public void download(String url, DownLoadObserver downLoadObserver) {
        download(url,null,downLoadObserver);
    }
    /**
     * 开始下载
     *
     ...
     */
    public void download(String url, File file, DownLoadObserver downLoadObserver) {
        if(file!=null){
            mFile = file;
        }
        Observable.just(url)
